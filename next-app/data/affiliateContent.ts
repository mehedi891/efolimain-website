...
const mvIcon = "/img/affiliate/mv_icon.png";
const pbIcon = "/img/affiliate/pbLogo.png";
const drIcon = "/img/affiliate/drLogo.png";
const emIcon = "/img/affiliate/emLogo.png";
const orIcon = "/img/affiliate/or_icon.png";
...
export interface GettingPaidItem {
  title: string;
  body: string;
}
...
export const links: AffiliateLinks = {
...
export const hero: AffiliateHero = {
...
export const steps: AffiliateStep[] = [
  {
    title: "Apply",
...
export const commission: AffiliateCommission = {
...
export const tracking: AffiliateTracking = {
  methods: [
    {
      tag: "Easiest",
...
export const apps: AffiliateApp[] = [
  {
    name: "MultiVariants",
    icon: mvIcon,
...
export const gettingPaid: GettingPaidItem[] = [
  {
...
export const terms: AffiliateTerm[] = [
  {
    title: "Who can join",
...
export const faqs: AffiliateFaq[] = [
  {
