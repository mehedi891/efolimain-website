...
const SectionHead = ({ eyebrow, title, lead, center = true, className = "" }) => (
  <motion.div
    variants={fadeUp}
    initial="hidden"
    whileInView="visible"
  ...
  <section className="relative overflow-hidden bg-gradient-to-b from-[#f2fbfa] via-white to-white">
    ...
    >
      ...
      <motion.div variants={fadeUp} className="mt-9 flex flex-wrap items-center justify-center gap-4">
        <Link to={links.apply} target="_blank" rel="noreferrer noopener">
          <Button
  ...
  <section className="bg-white py-16 md:py-24">
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      <p className="mt-6 text-center text-sm text-[#4B5154]">
        ...
        <Link to={links.apply} target="_blank" rel="noreferrer noopener" className="ml-1 font-semibold text-[#0D99FF] hover:underline">
          Talk to us →
        </Link>
      </p>
    </div>
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      {links.terms && (
        <p className="mt-8 text-center text-base text-[#4B5154]">
          Full terms:{" "}
          <Link to={links.terms} target="_blank" rel="noreferrer noopener" className="font-semibold text-[#0D99FF] hover:underline">
